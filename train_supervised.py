...
for i in range(args.n_runs):
    ...
    for epoch in range(args.n_epoch):
        ...
        for k in range(num_batch):
            ...
            sources_batch = train_data.src_ids[s_idx: e_idx]
            destinations_batch = train_data.dst_ids[s_idx: e_idx]
            timestamps_batch = train_data.timestamps[s_idx: e_idx]
            edge_idxs_batch = full_data.edge_idxes[s_idx: e_idx]
        ...
        val_auc = eval_node_classification(tgn, decoder, val_data, full_data.edge_idxes, BATCH_SIZE,
    ...
    if args.use_validation:
        ...
        test_auc = eval_node_classification(tgn, decoder, test_data, full_data.edge_idxes, BATCH_SIZE,
                                            n_neighbors=NUM_NEIGHBORS)
    else:
