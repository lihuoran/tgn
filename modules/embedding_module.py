...
class TimeEmbedding(EmbeddingModule):
    ...
    def compute_embedding(
        ...
        source_embeddings = memory[src_ids, :] * (1 + self.embedding_layer(time_diffs.unsqueeze(1)))
...
class GraphEmbedding(EmbeddingModule):
    ...
    def compute_embedding(
        ...
        source_nodes_torch = torch.from_numpy(src_ids).long().to(self.device)
        ...
        if self.use_memory:
            source_node_features = memory[src_ids, :] + source_node_features
        ...
        if n_layers == 0:
            ...
            neighbor_embeddings = neighbor_embeddings.view(len(src_ids), effective_n_neighbors, -1)
